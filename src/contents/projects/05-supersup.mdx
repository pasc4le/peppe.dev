...
Then, these agents communicate over a Redis pub/sub channel to a master agent. This agent serves different purpouses:
receiving all the messages and updates from the satellite agents, check the health and existence of satallite agents,
